...
func (*Data) Descriptor() ([]byte, []int) { return fileDescriptorDiff, []int{0} }
...
type ApplyRequest struct {
	...
	Dcparameters map[string]*Data              `protobuf:"bytes,3,rep,name=dcparameters" json:"dcparameters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func init() {
	proto.RegisterType((*Data)(nil), "containerd.services.diff.v1.Data")
...
func (this *ApplyRequest) String() string {
	...
	mapStringForDcparameters := "map[string]*Data{"
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Dcparameters == nil {
				m.Dcparameters = make(map[string]*Data)
			}
			var mapkey string
			var mapvalue *Data
			for iNdEx < postIndex {
...
var fileDescriptorDiff = []byte{
	...
	,
}
