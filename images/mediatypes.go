...
const (
	...
	MediaTypeDockerSchema2LayerPGP         = "application/vnd.docker.image.rootfs.diff.tar+pgp"
	MediaTypeDockerSchema2LayerForeign     = "application/vnd.docker.image.rootfs.foreign.diff.tar"
	MediaTypeDockerSchema2LayerGzip        = "application/vnd.docker.image.rootfs.diff.tar.gzip"
	MediaTypeDockerSchema2LayerGzipPGP     = "application/vnd.docker.image.rootfs.diff.tar.gzip+pgp"
